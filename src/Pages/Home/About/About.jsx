            ...
            <div className="md:h-screen py-5 flex items-center justify-center">
                <div className="flex w-full flex-col lg:flex-row">
                    <div className='lg:w-1/2 flex-1 relative'>
                        <img src={person} className="md:w-3/4 rounded-lg shadow-2xl object-cover" />
                        <img src={parts} className="md:w-1/2 md:h-2/3 md:absolute rounded-lg shadow-2xl left-1/3 top-1/3 border-8 mt-3" />
                    </div>
